...
def train_combined_from_config(
    ...
    trainer = NCA3DTrainer(
        ...
        damage_loss_type=training_config.get("damage_loss_type", "cross_entropy"),
        ...
        wandb_project=training_config.get("wandb_project", "nca-3d-combined"),
